...
| 1 — Market Dashboard MVP | Understand core market state in five minutes. | Nine core indicators, daily update, homepage. | Phase 0 definitions and verified source contracts. | **Authorized / in progress:** Phases 1.3A, 1.3B, 1.4A, 1.4B, 1.5A, and 1.5B are complete. A graphical dashboard remains unimplemented. |
